package com.di.ioc.test.tests.proxies;
...
import com.di.ioc.test.tests.proxies.beans.NonProxiedBean;
import com.di.ioc.test.tests.proxies.beans.ProxyBean;
import com.di.ioc.test.tests.proxies.beans.ProxyBeanImpl;
import com.di.ioc.test.tests.proxies.services.ConcreteProxyService;
